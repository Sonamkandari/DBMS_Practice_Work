...
-- cretaing the table first 
USE employee_tasks_db;
create table emloyeeSalary(
 employee_id int AUTO_INCREMENT primary key,
 employee_Name varchar(50),
 employee_salary int
);

--  inserting the values in the employeeSalary table
insert into emloyeeSalary(employee_Name,employee_salary) values
('sonam',1900000),
('Rishita',300000),
('shubham',800999),
('Harjeet',80009),
...
-- it will show only unique count no repeatatives 
-- Distinct
select distinct newTask from Tasks ;

-- Group by
select employee_salary, count(employee_salary)
 from emloyeeSalary group by employee_salary;
